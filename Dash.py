...
tile = col2.container(height=150, use_container_width=True)
...
grafico_3 = px.pie(pagamento, values="Total", names="Payment", title="DISTRIBUIÇÃO POR FORMA DE PAGAMENTO %")
