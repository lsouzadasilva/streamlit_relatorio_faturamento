...
grafico_4 = px.bar(pagamento, x="Payment", y="Total", title="FATURAMENTO POR FORMA DE PAGAMENTO", color="Payment", color_discrete_map={"Cash":"#FF2B2B", "Ewallet":"#0068C9", "Credit card":"#83C9FF"}, text_auto=True)
